        ...
        <div className="modal-content border-0 shadow-lg rounded-4">
          ...
          >
            <h6 className="modal-title fw-bold mb-0" id="accSetTitle">
              ការកំណត់គណនី / <span className="fw-normal">Account Settings</span>
            </h6>
            <button
              type="button"
              ...
              <form onSubmit={(e) => e.preventDefault()}>
                <div className="row g-3">
                  <div className="col-sm-6">
                    <label className="form-label fw-medium" htmlFor="firstName">
                      នាមខ្លួន
                    </label>
                    <input
                      id="firstName"
                  ...
                  <div className="col-sm-6">
                    <label className="form-label fw-medium" htmlFor="lastName">
                      នាមត្រកូល
                    </label>
                    <input
                      id="lastName"
