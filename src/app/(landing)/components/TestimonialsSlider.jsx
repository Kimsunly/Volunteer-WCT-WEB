    ...
    <section className="testimonials-modern position-relative">
      ...
      <div className="container position-relative">
        <div className="text-center mb-5" data-aos="fade-up">
          ...
          <h2 className="testimonial-title mt-3 mb-3">
            មតិយោបល់របស់អ្នកស្ម័គ្រចិត្ត
          </h2>
          <p className="testimonial-subtitle mx-auto">
            ការចូលរួមស្ម័គ្រចិត្តមិនមែនជាការផ្លាស់ប្តូរដល់សហគមន៍តែប៉ុណ្ណោះទេ
            ប៉ុន្តែវាជាភាពជោគជ័យផ្លូវចិត្តសម្រាប់អ្នកផងដែរ
          </p>
        </div>
