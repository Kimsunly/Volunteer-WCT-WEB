...
const defaultEvents = [
  {
    ...
    description: "ចូលរួមជាមួយយើងក្នុងការសម្អាតឆ្នេរ ដើម្បីរក្សាអនាម័យឆ្នេរសមុទ្ររបស់យើង",
    ...
    <section className="upcoming-modern position-relative">
      ...
      <div className="container position-relative">
        <div className="text-center mb-5" data-aos="fade-up">
          ...
          <h2 className="upcoming-title mt-3 mb-3">ព្រឹត្តិការណ៏មកដល់ឆាប់ៗនេះ</h2>
